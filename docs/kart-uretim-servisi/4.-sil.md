...
<mark style="color:red;">`DELETE`</mark> `{{Base Address}}/api/paywall/card/production/delete`
...
{% hint style="info" %}
Önemli: **Kart - Sil** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\

...
<mark style="color:orange;">`PUT`</mark> `{{Base Address}}/api/paywall/card/production/enable`
...
{% hint style="info" %}
Önemli: **Kart - Aktif Etme** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\
...
<table><thead><tr><th width="228">Parametre</th><th width="134">Tip</th><th width="96">Zorunlu</th><th>Açıklama</th></tr></thead><tbody><tr><td>CardId</td><td>int</td><td>Evet</td><td>Kart'ın Paywall'daki Id bilgisi. Oluşturma anında döner</td></tr></tbody></table>

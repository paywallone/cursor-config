...
<mark style="color:orange;">`PUT`</mark> `{{Base Address}}/api/paywall/card/production/description`
...
{% hint style="info" %}
Önemli: **Kart - Açıklama Güncelleme** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\

...
<mark style="color:green;">`POST`</mark> `{{Base Address}}/api/paywall/card/production/balance/decrease`
...
{% hint style="info" %}
Önemli: **Kart - Bakiye Azalt** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\

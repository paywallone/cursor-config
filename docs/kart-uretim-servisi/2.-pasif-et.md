...
<mark style="color:orange;">`PUT`</mark> `{{Base Address}}/api/paywall/card/production/disable`
...
{% hint style="info" %}
Önemli: **Kart - Pasif Etme** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\

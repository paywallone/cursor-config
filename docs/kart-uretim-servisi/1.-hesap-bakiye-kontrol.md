...
{% hint style="info" %}
Önemli: **Kart Üretim Sağlayıcısı - Hesap / Bakiye Kontrol** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\

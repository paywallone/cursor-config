...
<mark style="color:green;">`POST`</mark> `{{Base Address}}/api/payment/products`
...
{% hint style="info" %}
Önemli: **Ödeme Ürünleri** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\

...
<mark style="color:green;">`POST`</mark> `{{Base Address}}/api/payment/sync/cancel`
...
{% hint style="info" %}
Önemli: **Sync İptal** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\

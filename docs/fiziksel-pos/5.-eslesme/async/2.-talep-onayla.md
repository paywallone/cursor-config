...
<mark style="color:orange;">`PUT`</mark> `{{Base Address}}/api/pair/async/confirm`
...
{% hint style="info" %}
Önemli: **Async Eşleşme Onaylama** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\
...
<table><thead><tr><th width="268">Parametre</th><th width="80.33333333333331">Tip</th><th width="112">Zorunlu</th><th width="116">Uzunluk</th><th>Açıklama</th></tr></thead><tbody><tr><td><pre><code>PairAsyncRequestId

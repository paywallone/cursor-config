...
<mark style="color:red;">`DELETE`</mark> `{{Base Address}}/api/terminal/tag`
...
{% hint style="info" %}
Önemli: **Terminal Etiket Silme** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\
...
<table><thead><tr><th width="218">Parametre</th><th width="80.33333333333331">Tip</th><th width="90">Zorunlu</th><th width="124">Uzunluk</th><th>Açıklama</th></tr></thead><tbody><tr><td><pre><code>TerminalId

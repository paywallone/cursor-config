...
<mark style="color:orange;">`PUT`</mark> `{{Base Address}}/api/connection/disconnect`
...
{% hint style="info" %}
Önemli: **Bağlantı Kopar** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\

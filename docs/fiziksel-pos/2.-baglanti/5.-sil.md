...
<mark style="color:red;">`DELETE`</mark> `{{Base Address}}/api/connection`
...
{% hint style="info" %}
Önemli: **Bağlantı Silme** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\

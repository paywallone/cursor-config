...
{% hint style="info" %}
Önemli: **Bağlantı Detay** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\
...
```json5
{
    "Result": {
        ...
        "IsDelete": false,
        "IsProd": false,
        "ServiceParameters": { // Sağlayıcı özelinde Key/Value
            "Reporting_ApiKey": "***", // Response'da döner
            "Reporting_ApiToken": "***", // Response'da döner
            "AsyncPayment_ApiKey": "***", // Response'da döner
            "AsyncPayment_ApiToken": "***" // Response'da döner
        }
    },
    "Failed": false,
    "Message": null,

...
<mark style="color:blue;">`PUT`</mark> `{{WalletUrl}}/api/v1/commission`
...
```json
{
    ...
    "Value": {
        ...
        "CurrencyCode": "EUR",
        "IsActive": true,
        "CreatedAt": "2025-08-20T15:13:30.150152Z",
        "UpdatedAt": "2025-08-20T15:18:07.4399041Z"
    }
}
```

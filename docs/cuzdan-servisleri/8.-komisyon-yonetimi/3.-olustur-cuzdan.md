...
## Cüzdan Özelinde Komisyon Oluştur

<mark style="color:yellow;">`POST`</mark>`{{WalletUrl}}/api/v1/commission/by/wallet`&#x20;
...
```json
{
    ...
    "IsFailure": false,
    "Value": {
        "Id": "d2b5facc-a0b4-44b8-aade-beaed508acbb",
        "Level": "Wallet",
        "WalletId": "2ea244d1-6ed2-4eca-a84b-273c62f64606",
        "TransactionType": "Purchase",
        "FeeType": "Fixed",
        ...
        "ConditionThreshold": 1,
        "IsActive": true,
        "CreatedAt": "2025-08-22T00:42:37.35759Z",
        "UpdatedAt": null
    }
}
```

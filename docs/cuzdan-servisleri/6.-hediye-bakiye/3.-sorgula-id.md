...
<table><thead><tr><th width="177">Parametre</th><th>Açıklama</th></tr></thead><tbody><tr><td>Id</td><td>Tanımlanan hediye bakiyesinin kimlik bilgisi. Bu bilgi oluşturulma anında Paywall API'sinden dönmektedir</td></tr></tbody></table>

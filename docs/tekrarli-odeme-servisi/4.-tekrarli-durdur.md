...
<mark style="color:red;">`DELETE`</mark> `{{Base Adres}}/api/paywall/recurring/unsubscribe`

{% hint style="info" %}
Önemli: **Tekrarlı Ödeme Durdurma** servisini kullanabilmeniz için 'Header' alanında '**apikeypublic**' ve '**apiclientpublic**' parametrelerini göndermeniz gerekmektedir.\
\

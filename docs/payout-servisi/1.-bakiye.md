...
<mark style="color:blue;">`GET`</mark> `{{Base Address}}/api/paywall/payout/balance`
...
{% hint style="info" %}
Önemli: **Payout - Bakiye Kontrol** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\

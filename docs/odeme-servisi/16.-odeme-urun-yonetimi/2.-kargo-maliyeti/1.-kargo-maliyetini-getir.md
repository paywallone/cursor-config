...
## Ürün Kargo Maliyeti Görüntüle

<mark style="color:blue;">`GET`</mark> `{{Base Adres}}/api/paywall/product/cargocost`

{% hint style="info" %}
Önemli: **Kargo Maliyeti Getir** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\

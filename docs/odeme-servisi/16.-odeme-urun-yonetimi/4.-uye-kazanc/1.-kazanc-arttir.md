...
## Ürün - Üye Kazanç Arttır

<mark style="color:orange;">`PUT`</mark> `{{Base Adres}}/api/paywall/product/member/earning/increase`
...
{% hint style="info" %}
Önemli: **Ürün - Üye Kazanç Arttır** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\

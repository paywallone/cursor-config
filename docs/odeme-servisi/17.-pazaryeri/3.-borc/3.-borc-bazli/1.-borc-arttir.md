...
<mark style="color:orange;">`PUT`</mark> `{{Base Adres}}/api/paywall/marketplace/debt/increase/id`

{% hint style="info" %}
Önemli: **Borç Arttırma** servisini kullanabilmeniz için 'Header' alanında '**apikeypublic**' ve '**apiclientpublic**' parametrelerini göndermeniz gerekmektedir.\
\
...
<table><thead><tr><th width="189">Parametre</th><th width="100.33333333333331">Tip</th><th>Açıklama</th></tr></thead><tbody><tr><td>Id</td><td>int</td><td>Borca ait Id (Kimlik) bilgisi</td></tr><tr><td>Debt</td><td>decimal</td><td>Borcu arttırtmak istediğiniz tutar bilgisi</td></tr></tbody></table>

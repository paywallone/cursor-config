...
## Kazanç kimliğiyle (EarningId) kazanç azalt

<mark style="color:orange;">`PUT`</mark> `{{Base Adres}}/api/paywall/marketplace/earning/decrease/id`

{% hint style="info" %}
Önemli: **Kazanç Azaltma** servisini kullanabilmeniz için 'Header' alanında '**apikeypublic**' ve '**apiclientpublic**' parametrelerini göndermeniz gerekmektedir.\
\
...
<table><thead><tr><th width="189">Parametre</th><th width="100.33333333333331">Tip</th><th>Açıklama</th></tr></thead><tbody><tr><td>Id</td><td>int</td><td>Kazanca ait Id (kimlik) bilgisi</td></tr><tr><td>Earning</td><td>decimal</td><td>Kazancı azaltmak istediğiniz tutar bilgisi</td></tr></tbody></table>

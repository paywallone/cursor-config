...
## Ödeme bazlı tekrar dene

<mark style="color:orange;">`PUT`</mark> `{{Base Adres}}/api/paywall/marketplace/earning/put/retry/product`

{% hint style="info" %}
Önemli: **Ödeme Bazlı Tekrar Dene** servisini kullanabilmeniz için 'Header' alanında '**apikeypublic**' ve '**apiclientpublic**' parametrelerini göndermeniz gerekmektedir.\
\

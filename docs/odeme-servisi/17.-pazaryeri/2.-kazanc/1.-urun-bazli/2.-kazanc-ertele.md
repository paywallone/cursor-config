...
## Ürün bazlı kazanç erteleme

<mark style="color:orange;">`PUT`</mark> `{{Base Adres}}/api/paywall/marketplace/earning/postpone/product`

{% hint style="info" %}
Önemli: **Ürün Bazlı Kazanç Erteleme** servisini kullanabilmeniz için 'Header' alanında '**apikeypublic**' ve '**apiclientpublic**' parametrelerini göndermeniz gerekmektedir.\
\
...
<table><thead><tr><th width="189">Parametre</th><th width="100.33333333333331">Tip</th><th>Açıklama</th></tr></thead><tbody><tr><td>ProductId</td><td>int</td><td>Ürüne ait Id (kimlik) bilgisi. Ödeme anında Paywall cevap nesnesi içerisinde dönmektedir</td></tr><tr><td>Day</td><td>int</td><td>Kazancın ertelenmek istendiği gün sayısı. 10 belirtildiğinde kazanç var olan tarihinden 10 gün sonra yatar</td></tr><tr><td>ApplyAll</td><td>bool</td><td>Hem ürüne hem de ürünle birlikte Platform (Siz) için ürüyen hak edişe etki eder.<br><br>Örnek: TRUE gönderilmesi durumunda hem satıcınızın hak edişi etkilenir hem de sizin hak edişiniz etkilenir.</td></tr></tbody></table>

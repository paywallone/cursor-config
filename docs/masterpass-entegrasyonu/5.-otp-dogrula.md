...
{% hint style="info" %}
Önemli: **Masterpass - Otp Doğrula** servisini kullanabilmeniz için 'Header' alanında '**apikeyprivate**' ve '**apiclientprivate**' parametrelerini göndermeniz gerekmektedir.\
\
...
<table><thead><tr><th width="228">Parametre</th><th width="106">Tip</th><th width="123">Zorunlu</th><th>Açıklama</th></tr></thead><tbody><tr><td>OtpToken</td><td>string</td><td>Evet</td><td>Otp gerektiren işlem anında API'den cevap parametreleri içerisinde yer alır<br><br><code>Masterpass > Result > Token</code></td></tr><tr><td>OtpCode</td><td>string</td><td>Evet</td><td>Ekranda kullanıcıdan aldığınız Otp kodu</td></tr><tr><td>ForLinkToMerchant</td><td>bool</td><td>Hayır</td><td>Eğer kullanıcı ile üye işyeri şirket arasındaki bağlantının kurulabilmesi için OTP doğrulaması yapılıyorsa, bu parametre <code>true</code> gönderilmelidir</td></tr><tr><td>SessionId</td><td>Guid</td><td>Evet</td><td><a href="1.-oturum-olustur">Oturum Kimliği</a> bilgisi</td></tr></tbody></table>
